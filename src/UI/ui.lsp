...
(defun helpUse () (pcol 1) 
    (pcol 4) (prgbfore 30 52 194) (format t "Utilisation de ce sytème expert : ") (pRes) (newline)
...
(defun app ()
    ...
    (let ((in (read-line)))
        (cond 
            ...
            ((string= in "exit") (pcol 1) (format t "Au revoir ") (sad) (pres) (newline))
...
(defun afficherPokemon (pokemons)
    (dolist (pokemon pokemons)
        (format t "Nom : ~a" (faits:pokemon-name pokemon)) (newline)
        (let ((typesPoke (faits:pokemon-typesPoke pokemon)))
            (format t "Types : ")(newline)
